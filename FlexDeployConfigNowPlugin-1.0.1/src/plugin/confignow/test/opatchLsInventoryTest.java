...
import plugin.confignow.operations.opatchLsInventory;
 ...
 */
public class opatchLsInventoryTest {
    ...
    public void opatchLsInventoryCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchLsInventory();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("soa12c", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void opatchLsInventoryMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchLsInventory();
    ...
    public void opatchLsInventoryInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchLsInventory();
