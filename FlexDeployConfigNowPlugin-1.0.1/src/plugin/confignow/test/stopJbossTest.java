...
import plugin.confignow.operations.stopJboss;
...
public class stopJbossTest {
    ...
    public void stopJbossCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopJboss();
    ...
    public void stopJbossMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopJboss();
    ...
    public void stopJbossInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopJboss();
