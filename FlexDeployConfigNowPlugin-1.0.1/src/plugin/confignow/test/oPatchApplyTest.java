...
import plugin.confignow.operations.opatchApply;
...
public class oPatchApplyTest {
    ...
    public void opatchApplyCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchApply();
    ...
    public void opatchApplyMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchApply();
    ...
    public void opatchApplyInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchApply();
