...
import plugin.confignow.operations.startKarafSession;
 ...
 */
public class startKarafSessionTest {
    ...
    public void startKarafSessionCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startKarafSession();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("fuse_example", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void startKarafSessionMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startKarafSession();
    ...
    public void startKarafSessionInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startKarafSession();
