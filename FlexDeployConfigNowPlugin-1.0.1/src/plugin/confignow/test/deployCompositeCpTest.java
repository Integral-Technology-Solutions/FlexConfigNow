...
import plugin.confignow.operations.deployCompositeCp;
 ...
 */
public class deployCompositeCpTest {
    ...
    public void deployCompositeCpCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployCompositeCp();
    ...
    public void deployCompositeCpMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployCompositeCp();
    ...
    public void deployCompositeCpInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployCompositeCp();
