...
import plugin.confignow.operations.deployJboss;
...
public class deployJbossTest {
    ...
    public void deployJbossCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployJboss();
    ...
    public void deployJbossMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployJboss();
    ...
    public void deployJbossInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployJboss();
