...
import plugin.confignow.operations.runCli;
...
public class runCliTest {
    ...
    public void runCliCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new runCli();
    ...
    public void runCliMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new runCli();
    ...
    public void runCliInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new runCli();
