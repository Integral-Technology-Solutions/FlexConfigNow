...
import plugin.confignow.operations.opatchRollback;
 ...
 */
public class opatchRollbackTest {
    ...
    public void opatchRollbackCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchRollback();
    ...
    public void opatchRollbackissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchRollback();
    ...
    public void opatchRollbackInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new opatchRollback();
