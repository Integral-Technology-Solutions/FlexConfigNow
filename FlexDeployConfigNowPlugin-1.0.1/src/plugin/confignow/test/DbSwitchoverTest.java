...
import plugin.confignow.operations.DbSwitchover;
...
public class DbSwitchoverTest {
    ...
    @Test
    public void DbSwitchoverCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new DbSwitchover();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("rac_example", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void DbSwitchoverMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new DbSwitchover();
    ...
    public void DbSwitchoverInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new DbSwitchover();
