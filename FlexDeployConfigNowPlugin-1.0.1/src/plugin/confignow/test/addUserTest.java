...
import plugin.confignow.operations.addUser;
...
public class addUserTest {
    ...
    public void addUserCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addUser();
    ...
    public void addUserMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addUser();
    ...
    public void addUserInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addUser();
