...
import plugin.confignow.operations.undeployComposite;
 ...
 */
public class undeployCompositeTest {
    ...
    public void undeployCompositeCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployComposite();
    ...
    public void undeployCompositeMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployComposite();
    ...
    public void undeployCompositeInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployComposite();
