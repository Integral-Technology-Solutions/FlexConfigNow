...
import plugin.confignow.operations.remoteDeployApp;
 ...
 */
public class remoteDeployAppTest {
    ...
    public void remoteDeployAppCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteDeployApp();
    ...
    public void remoteDeployAppMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteDeployApp();
    ...
    public void remoteDeployAppInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteDeployApp();
