...
import plugin.confignow.operations.configureNodeManager;
 ...
 */
public class configureNodeManagerTest {
    ...
    @Test
    public void configureNodeManagerCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureNodeManager();
    ...
    public void configureNodeManagerMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureNodeManager();
    ...
    public void configureNodeManagerInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureNodeManager();
