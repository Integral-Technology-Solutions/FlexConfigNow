...
import plugin.confignow.operations.deployComposite;
 ...
 */
public class deployCompositeTest {
    ...
    public void deployCompositeCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployComposite();
    ...
    public void deployCompositeMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployComposite();
    ...
    public void deployCompositeInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployComposite();
