...
import plugin.confignow.operations.undeployFuseApp;
 ...
 */
public class undeployFuseAppTest {
    ...
    @Test
    public void undeployFuseAppCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployFuseApp();
    ...
    public void undeployFuseAppMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployFuseApp();
    ...
    public void undeployFuseAppInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployFuseApp();
