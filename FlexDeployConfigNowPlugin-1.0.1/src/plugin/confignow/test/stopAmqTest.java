...
import plugin.confignow.operations.stopAmq;
...
public class stopAmqTest {
    ...
    public void stopAmqCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopAmq();
    ...
    public void stopAmqMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopAmq();
    ...
    public void stopAmqInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopAmq();
