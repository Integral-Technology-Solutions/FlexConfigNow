...
import plugin.confignow.operations.stopFuse;
...
public class stopFuseTest {
    ...
    public void stopFuseCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopFuse();
    ...
    public void stopFuseMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopFuse();
    ...
    public void stopFuseInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopFuse();
