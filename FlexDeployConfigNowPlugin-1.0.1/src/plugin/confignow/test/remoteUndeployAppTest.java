...
import plugin.confignow.operations.remoteUndeployApp;
 ...
 */
public class remoteUndeployAppTest {
    ...
    public void remoteUndeployAppCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteUndeployApp();
    ...
    public void remoteUndeployAppMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteUndeployApp();
    ...
    public void remoteUndeployAppInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new remoteUndeployApp();
