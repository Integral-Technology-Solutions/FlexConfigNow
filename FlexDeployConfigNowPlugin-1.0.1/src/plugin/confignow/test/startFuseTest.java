...
import plugin.confignow.operations.startFuse;
...
public class startFuseTest {
    ...
    public void startFuseCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startFuse();
    ...
    public void startFuseMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startFuse();
    ...
    public void startFuseInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startFuse();
