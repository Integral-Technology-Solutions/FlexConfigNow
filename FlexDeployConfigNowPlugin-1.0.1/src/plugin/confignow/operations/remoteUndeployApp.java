 ...
 */
public class remoteUndeployApp extends AbstractPluginProvider {

    private static final String CLZ_NAM = remoteUndeployApp.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "remote_undeploy_app";
