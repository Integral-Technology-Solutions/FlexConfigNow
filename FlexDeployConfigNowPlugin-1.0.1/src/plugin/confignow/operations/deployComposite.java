 ...
 */
public class deployComposite extends AbstractPluginProvider {

    private static final String CLZ_NAM = deployComposite.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "deploy_composite";
