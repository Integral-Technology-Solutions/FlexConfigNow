 ...
 */
public class remoteDeployApp extends AbstractPluginProvider {

    private static final String CLZ_NAM = remoteDeployApp.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "remote_deploy_app";
