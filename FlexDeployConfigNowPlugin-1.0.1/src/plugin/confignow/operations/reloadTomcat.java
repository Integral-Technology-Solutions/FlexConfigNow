 ...
 */
public class reloadTomcat extends AbstractPluginProvider {

    private static final String CLZ_NAM = reloadTomcat.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "reload_tomcat_app";
