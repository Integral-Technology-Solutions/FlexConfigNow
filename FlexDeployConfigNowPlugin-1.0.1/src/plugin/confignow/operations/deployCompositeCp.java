 ...
 */
public class deployCompositeCp extends AbstractPluginProvider {

    private static final String CLZ_NAM = deployCompositeCp.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "deploy_composite_with_cp";
