...
/**
 * Created by Matt on 24/08/2017.
 */
public class activateComposite extends AbstractPluginProvider {

    private static final String CLZ_NAM = activateComposite.class.getName();
    ...
    public PluginResult execute(){
        ...
        String[] commandLine = {"ConfigNOW", "activate_composite", mEnvironment, mConfigFile};
