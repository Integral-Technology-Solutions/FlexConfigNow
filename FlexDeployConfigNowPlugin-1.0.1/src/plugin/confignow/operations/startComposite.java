 ...
 */
public class startComposite extends AbstractPluginProvider {

    private static final String CLZ_NAM = startComposite.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "start_composite";
