 ...
 */
public class undeployComposite extends AbstractPluginProvider {

    private static final String CLZ_NAM = undeployComposite.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "undeploy_composite";
