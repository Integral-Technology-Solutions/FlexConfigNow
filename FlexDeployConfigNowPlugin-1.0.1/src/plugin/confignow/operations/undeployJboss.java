 ...
 */
public class undeployJboss extends AbstractPluginProvider {

    private static final String CLZ_NAM = undeployJboss.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "undeploy_boss_app";
