 ...
 */
public class deployFuseApp extends AbstractPluginProvider {

    private static final String CLZ_NAM = deployFuseApp.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "deploy_fuse_app";
