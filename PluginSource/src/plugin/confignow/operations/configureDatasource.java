 ...
 */
public class configureDatasource extends AbstractPluginProvider {

    private static final String CLZ_NAM = configureDatasource.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "configure_datasource";
