 ...
 */
public class setDefaultComposite extends AbstractPluginProvider {

    private static final String CLZ_NAM = setDefaultComposite.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "set_default_composite";
