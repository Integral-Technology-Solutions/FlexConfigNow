 ...
 */
public class undeployTomcat extends AbstractPluginProvider {

    private static final String CLZ_NAM = undeployTomcat.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "undeploy_tomcat_app";
