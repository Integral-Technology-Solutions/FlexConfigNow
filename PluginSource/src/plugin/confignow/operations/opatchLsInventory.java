 ...
 */
public class opatchLsInventory extends AbstractPluginProvider {

    private static final String CLZ_NAM = opatchLsInventory.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "opatch_lsinventory";
