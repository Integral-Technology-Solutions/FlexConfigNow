 ...
 */
public class startKarafSession extends AbstractPluginProvider {

    private static final String CLZ_NAM = startKarafSession.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "start_karaf_session";
