 ...
 */
public class startWlsAdmin extends AbstractPluginProvider {

    private static final String CLZ_NAM = startWlsAdmin.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "start_wls_admin";
