 ...
 */
public class passwordEncrypter extends AbstractPluginProvider {

    private static final String CLZ_NAM = passwordEncrypter.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "password_encrypter";
