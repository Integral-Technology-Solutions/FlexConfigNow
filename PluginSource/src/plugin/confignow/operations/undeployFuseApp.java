 ...
 */
public class undeployFuseApp extends AbstractPluginProvider {

    private static final String CLZ_NAM = undeployFuseApp.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "undeploy_fuse_app";
