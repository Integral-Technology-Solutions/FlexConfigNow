 ...
 */
public class addTomcatUser extends AbstractPluginProvider {

    private static final String CLZ_NAM = addTomcatUser.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "add_tomcat_user";
