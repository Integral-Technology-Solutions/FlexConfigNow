 ...
 */
public class shutdownAllServers extends AbstractPluginProvider {

    private static final String CLZ_NAM = shutdownAllServers.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "shutdown_all_servers";
