 ...
 */
public class setupOerReports extends AbstractPluginProvider {

    private static final String CLZ_NAM = setupOerReports.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "setup_oer_reports";
