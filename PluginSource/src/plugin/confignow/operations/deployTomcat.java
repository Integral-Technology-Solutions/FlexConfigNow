 ...
 */
public class deployTomcat extends AbstractPluginProvider {

    private static final String CLZ_NAM = deployTomcat.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "deploy_tomcat_app";
