 ...
 */
public class deployOsbConfig extends AbstractPluginProvider {

    private static final String CLZ_NAM = deployOsbConfig.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "deploy_osb_config";
