 ...
 */
public class opatchRollback extends AbstractPluginProvider {

    private static final String CLZ_NAM = opatchRollback.class.getName();
    ...
    public PluginResult execute(){
        ...
        String command = "opatch_rollback";
