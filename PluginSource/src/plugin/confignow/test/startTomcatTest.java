...
import plugin.confignow.operations.startTomcat;
...
public class startTomcatTest {
    ...
    public void startTomcatCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startTomcat();
    ...
    public void startTomcatMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startTomcat();
    ...
    public void startTomcatInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startTomcat();
