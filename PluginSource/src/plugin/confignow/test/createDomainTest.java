...
import plugin.confignow.operations.createDomain;
...
public class createDomainTest {
    ...
    public void createDomainCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new createDomain();
    ...
    public void createDomainMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new createDomain();
    ...
    public void createDomainInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new createDomain();
