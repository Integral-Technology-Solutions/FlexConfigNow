...
import plugin.confignow.operations.deployApps;
...
public class deployAppsTest {
    ...
    public void deployAppsCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployApps();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("deploy_example", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void deployAppsMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployApps();
    ...
    public void deployAppsInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployApps();
