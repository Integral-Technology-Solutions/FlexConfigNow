...
import plugin.confignow.operations.stopWlsAdmin;
...
public class stopWlsAdminTest {
    ...
    @Test
    public void stopWlsAdminCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopWlsAdmin();
    ...
    public void stopWlsAdminMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopWlsAdmin();
    ...
    public void stopWlsAdminInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopWlsAdmin();
