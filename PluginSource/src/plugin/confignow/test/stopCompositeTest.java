...
import plugin.confignow.operations.stopComposite;
 ...
 */
public class stopCompositeTest {
    ...
    public void stopCompositeCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopComposite();
    ...
    public void stopCompositeMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopComposite();
    ...
    public void stopCompositeInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopComposite();
