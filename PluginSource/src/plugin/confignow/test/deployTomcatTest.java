...
import plugin.confignow.operations.deployTomcat;
...
public class deployTomcatTest {
    ...
    public void deployTomcatCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployTomcat();
    ...
    public void deployTomcatMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployTomcat();
    ...
    public void deployTomcatInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployTomcat();
