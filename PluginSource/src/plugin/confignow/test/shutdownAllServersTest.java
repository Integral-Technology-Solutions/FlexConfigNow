...
import plugin.confignow.operations.shutdownAllServers;
 ...
 */
public class shutdownAllServersTest {
    ...
    public void shutdownAllServersCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new shutdownAllServers();
    ...
    public void shutdownAllServersMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new shutdownAllServers();
    ...
    public void shutdownAllServersInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new shutdownAllServers();
