...
import plugin.confignow.operations.startComposite;
 ...
 */
public class startCompositeTest {
    ...
    public void startCompositeCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startComposite();
    ...
    public void startCompositeMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startComposite();
    ...
    public void startCompositeInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new startComposite();
