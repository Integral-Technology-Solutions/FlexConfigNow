...
import plugin.confignow.operations.deployFuseApp;
 ...
 */
public class deployFuseAppTest {
    ...
    @Test
    public void deployFuseAppCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployFuseApp();
    ...
    public void deployFuseAppMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployFuseApp();
    ...
    public void deployFuseAppInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new deployFuseApp();
