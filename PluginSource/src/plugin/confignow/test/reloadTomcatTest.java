...
import plugin.confignow.operations.reloadTomcat;
...
public class reloadTomcatTest {
    ...
    public void reloadTomcatCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new reloadTomcat();
    ...
    public void reloadTomcatMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new reloadTomcat();
    ...
    public void reloadTomcatInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new reloadTomcat();
