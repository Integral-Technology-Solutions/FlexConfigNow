...
import plugin.confignow.operations.undeployJboss;
 ...
 */
public class undeployJbossTest {
    ...
    public void undeployJbossCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployJboss();
    ...
    public void undeployJbossMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployJboss();
    ...
    public void undeployJbossInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployJboss();
