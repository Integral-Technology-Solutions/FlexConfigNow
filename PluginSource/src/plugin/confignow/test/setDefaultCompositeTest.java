...
import plugin.confignow.operations.setDefaultComposite;
 ...
 */
public class setDefaultCompositeTest {
    ...
    public void setDefaultCompositeCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setDefaultComposite();
    ...
    public void setDefaultCompositeMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setDefaultComposite();
    ...
    public void setDefaultCompositenvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setDefaultComposite();
