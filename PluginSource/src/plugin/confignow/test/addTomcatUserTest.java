...
import plugin.confignow.operations.addTomcatUser;
 ...
 */
public class addTomcatUserTest {
    ...
    public void tomcatAddUserCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addTomcatUser();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("tomcat_example", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void tomcatAddUserMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addTomcatUser();
    ...
    public void tomcatAddUserInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new addTomcatUser();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("tomcatexample_doesnt_exist", PropertyValue.PropertyTypeEnum.String, false));
