...
import plugin.confignow.operations.setupOerReports;
 ...
 */
public class setupOerReportsTest {
    ...
    public void setupOerReportsCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setupOerReports();
    ...
    public void setupOerReportsMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setupOerReports();
    ...
    public void setupOerReportsInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new setupOerReports();
