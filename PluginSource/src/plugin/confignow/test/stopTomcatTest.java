...
import plugin.confignow.operations.stopTomcat;
...
public class stopTomcatTest {
    ...
    @Test
    public void stopTomcatCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopTomcat();
    ...
    public void stopTomcatMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopTomcat();
    ...
    public void stopTomcatInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new stopTomcat();
