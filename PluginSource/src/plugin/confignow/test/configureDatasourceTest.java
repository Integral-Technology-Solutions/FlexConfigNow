...
import plugin.confignow.operations.configureDatasource;
 ...
 */
public class configureDatasourceTest {
    ...
    public void configureDatasourceCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureDatasource();

        ConcurrentHashMap<String, PropertyValue> inputs = new ConcurrentHashMap<>();
        inputs.put(configNowProperties.FDCN_CONFIG_FILE, new PropertyValue("jboss_example", PropertyValue.PropertyTypeEnum.String, false));
    ...
    public void configureDatasourceMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureDatasource();
    ...
    public void configureDatasourceInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new configureDatasource();
