...
import plugin.confignow.operations.undeployTomcat;
 ...
 */
public class undeployTomcatTest {
    ...
    public void undeployTomcatCorrectConfig() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployTomcat();
    ...
    public void undeployTomcatMissingConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployTomcat();
    ...
    public void undeployTomcatInvalidConfigFile() throws FlexCheckedException {
        AbstractPluginProvider pluginProvider = new undeployTomcat();
